...
<head>
    ...
    <title>Home Page - Online Birth Notification System</title>
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">Online Birth Notification System</a>
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="user/login.php">User</a>
                                                                ...
                                                                <li class="nav-item">
                                    <a class="nav-link" href="user/search.php"></a>
                                </li>
                                <li class="nav-item">
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg2.jpg);">
 ...
 Online Birth Notification System 
