...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Notification applied succesfully")</script>';
...
echo "<script>alert('Date of Birth and Father Name already exist. Please try again');</script>";
...
<head>
    ...
    <title>Application Form | Online Birth Notification System</title>
