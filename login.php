...
<head>
    ...
    <title>Login | Online Birth Notification System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Online Birth Notification System</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
...
<p style="text-align: center;"><a href="../Homepage.php">Back Home!!!</a></p>
                                    </div>
                                </div>
                            </div>
                        </form>
